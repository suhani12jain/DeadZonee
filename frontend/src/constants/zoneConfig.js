...
export const ZONE_CONFIG = {
    ...
    concrete_wall:{ attenuation: 18.0, priority_weight: 0.2, allow_router: false, color: '#78716C', label: 'Concrete Wall' },
    drywall:      { attenuation: 4.0,  priority_weight: 0.5, allow_router: false, color: '#D6D3D1', label: 'Drywall' },
    glass_wall:   { attenuation: 2.5,  priority_weight: 0.6, allow_router: true,  color: '#A5F3FC', label: 'Glass Wall' },
  }
