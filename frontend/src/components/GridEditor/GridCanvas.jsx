...
import WhatIfDeltaOverlay from './WhatIfDeltaOverlay'
    ...
    <div className="grid-canvas-wrap blueprint-bg">
      ...
      >
        ...
        <Layer listening={false}>
          ...
          {overlays.whatif && whatIf?.delta_matrix && (
            <WhatIfDeltaOverlay
              viewMode={whatIfViewMode}
              deltaMatrix={whatIf.delta_matrix}
              newDeadMask={whatIf.new_dead_mask}
              recoveredMask={whatIf.recovered_mask}
              cellW={cellW}
              cellH={cellH}
