...
# ── What-If Agent (in-memory simulation; does not persist grid changes) ─────
class WhatIfManualChange(BaseModel):
    """Single cell or rectangle of cells to repaint for the simulation."""
    zone_type: str
    row:       Optional[int] = None
    col:       Optional[int] = None
...
class WhatIfPayload(BaseModel):
    ...
    manual_changes:  Optional[List[WhatIfManualChange]] = None